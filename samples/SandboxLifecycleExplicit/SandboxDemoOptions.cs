namespace SandboxLifecycleExplicit;
...
public sealed class SandboxDemoOptions
{
    ...
    public string BackendUrl { get; set; } = "http://host.docker.internal:5086";

    /// <summary>gRPC control-stream URL the container's runner dials.</summary>
    public string GrpcBackendUrl { get; set; } = "http://host.docker.internal:5087";
