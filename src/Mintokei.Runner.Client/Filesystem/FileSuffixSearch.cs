...
/// <summary>
/// Finds files in a working directory whose relative path ends with a given suffix.
/// </summary>
internal static class FileSuffixSearch
{
    ...
    {
        if (pathSegments.Length == 0 || suffixSegments.Length == 0)
            return 0;
    ...
    {
        if (depth > MaxDepth || scanned > MaxFilesScanned)
            return;
